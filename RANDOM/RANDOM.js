var Engilsh = new Array(
    ...
    '네가 봤던 것과 상관없어',
    "It has nothing to do with what you saw",
    '내가 너에게 말해준 것과는 상관없어',
    "It has nothing to do with what i told you",
    '일어난 일과는 상관없어',
    "It has nothing to do with what heppen",
    // 37
    '네가 올 수 있는지 알려줘',
    ...
    '너에게 무엇이 일어났는지 알려줄게',
    "Let me tell you what heppened",
    '너에게 진실을 말해줄게',
    "Let me tell you the truth",
    // 40
    '너에게 그 결과를 알려줄게',
    "I'll let me know the result",
    '너에게 가능한 한 빨리 알려줄게',
    "I'll let me know as soon as possible",
    '너에게 지금 당장 알려줄게',
    "I'll let me know right now",
    '너에게 네가 필요하면 알려줄게',
    "I'll let me know if i need you",
    //41
    "네가 가지 않으면 좋겠어",
    ...
    "나 그걸 다시 할 수 있을거라고 생각도 못했어",
    "I never thought I couid do it again",
    "나 그게 너라고 생각도 못했어",
